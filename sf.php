 ...
 */
/*
	Plugin Name: Ajaxy Live Search Custom by Chen peiqing
	Plugin URI:
	Description: inhert Ajaxy Live Search.
	Version: 0.1
	Author: peiqing
	Author URI: http://blogs.qingtianxueri.com
  ...
  function admin_page()
  {
    ...
    ?>
      ...
      <div class="wrap">
          ...
          <ul class="subsubsub">
              <li class="active"><a href="<?php echo menu_page_url('ajaxy_sf_admin', false); ?>"
                                    class="<?php echo(!$tab ? 'current' : ''); ?>"><?php _e('General settings'); ?><span
                              class="count"></span></a> |
              </li>
              <li class="active"><a href="<?php echo menu_page_url('ajaxy_sf_admin', false) . '&tab=post_type'; ?>"
                                    class="<?php echo($tab == 'post_type' ? 'current' : ''); ?>"><?php _e('Post type Search'); ?>
                      <span class="count"></span></a> |
              </li>
              <li class="active"><a href="<?php echo menu_page_url('ajaxy_sf_admin', false) . '&tab=taxonomy'; ?>"
                                    class="<?php echo($tab == 'taxonomy' ? 'current' : ''); ?>"><?php _e('Taxonomy Search'); ?>
                      <span class="count"></span></a> |
              </li>
              <li class="active"><a href="<?php echo menu_page_url('ajaxy_sf_admin', false) . '&tab=author'; ?>"
                                    class="<?php echo($tab == 'author' ? 'current' : ''); ?>"><?php _e('Author Search'); ?>
                      <span class="count"></span></a> |
              </li>

              <li class="active ajaxy-sf-new"><a
                          href="<?php echo menu_page_url('ajaxy_sf_admin', false) . '&tab=woocommerce'; ?>"
                          class="<?php echo($tab == 'woocommerce' ? 'current' : ''); ?>"><?php _e('WooCommerce'); ?>
                      <span class="count-new">New *</span></a> |
              </li>
              ...
              <li class="active"><a href="<?php echo menu_page_url('ajaxy_sf_admin', false) . '&tab=themes'; ?>"
                                    class="<?php echo($tab == 'themes' ? 'current' : ''); ?>"><?php _e('Themes'); ?>
                      <span class="count"></span></a> |
              </li>
              <li class="active"><a href="<?php echo menu_page_url('ajaxy_sf_admin', false) . '&tab=shortcode'; ?>"
                                    class="<?php echo($tab == 'shortcode' ? 'current' : ''); ?>"><?php _e('Shortcodes'); ?>
                      <span class="count"></span></a> |
              </li>
              <li class="active"><a href="<?php echo menu_page_url('ajaxy_sf_admin', false) . '&tab=preview'; ?>"
                                    class="<?php echo($tab == 'preview' ? 'current' : ''); ?>"><?php _e('Preview'); ?>
          ...
          <div id="message-bottom" class="updated">
              <table>
                  <tr>
                      ...
                      <td>
                          <a target="_blank"
                             href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=QDDZQHHCPUDDG"><img
                                      class="aligncenter size-full wp-image-180" title="btn_donateCC_LG" alt=""
                                      src="https://www.paypalobjects.com/en_US/i/btn/btn_donateCC_LG.gif" width="147"
                                      height="47"></a>
                      </td>
                  </tr>
              </table>
...
*/
  ...
  function post_object($id, $term_id = false, $matches = false)
  {
    ...
    $size = array('height' => $this->get_style_setting('thumb_height', 50), 'width' => $this->get_style_setting('thumb_width', 50));
    if ($post != null) {
...
*/
  ...
  function form_shortcode($atts = array())
  {
    $m = uniqid();
    $scat = (array)$this->get_setting('category');
    if (strpos($this->get_style_setting('border-color', 'dddddd'), 'rgba') === false) {
        $border_color = " #" . $this->get_style_setting('border-color', 'dddddd');
    } else {
        $border_color = " " . $this->get_style_setting('border-color', 'dddddd');
    }
    ...
    $settings = array(
      ...
      'border' => $this->get_style_setting('border-width', '1') . "px " . $this->get_style_setting('border-type', 'solid') . $border_color,
  ...
  function selective_input_shortcode($atts = array())
  {
    ...
    $settings = array(
      'id' => $m,
      'label' => $this->get_style_setting('search_label', 'Search'),
      'expand' => isset($atts['expand']) ? $atts['expand'] : 0,
      'width' => $this->get_style_setting('width', 180),
      'border' => $this->get_style_setting('border-width', '0') . "px " . $this->get_style_setting('border-type', 'solid') . " #" . $this->get_style_setting('border-color', 'transparent'),
